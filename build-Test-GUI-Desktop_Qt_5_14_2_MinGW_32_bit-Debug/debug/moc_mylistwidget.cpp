...
#include <memory>
#include "../../Test-GUI/mylistwidget.h"
...
QT_MOC_LITERAL(1, 13, 11), // "sig_testSig"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 13), // "slot_testSlot"
QT_MOC_LITERAL(4, 40, 12) // "slot_trigger"

    },
    "MyListWidget\0sig_testSig\0\0slot_testSlot\0"
    "slot_trigger"
};
...
void MyListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_testSig((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->slot_testSlot(); break;
        case 2: _t->slot_trigger(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyListWidget::sig_testSig)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyListWidget::sig_testSig(int _t1)
{
